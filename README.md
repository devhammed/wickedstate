...
<script type="module">
    import { render } from 'https://esm.sh/wickedstate@0.1.4';
...
We are using [esm.sh](https://esm.sh) CDN in the example above, you can replace it with any other CDN of your choice that supports ES Modules e.g `https://cdn.skypack.dev/wickedstate@0.1.4`.
